...
export function SpacesNamePutRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpacesNamePutRequest {
...
export function SpacesNamePutRequestToJSON(value?: SpacesNamePutRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
