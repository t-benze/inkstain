 ...
 */
const getDocumentAttributes = async (ctx: Router.RouterContext) => {
  const { spaceKey } = ctx.params;
  const documentPath = ctx.query.path;
  const documentDirectory = documentPath + '.ink';
 ...
 */
const addUpdateDocumentAttributes = async (ctx: Router.RouterContext) => {
  const { spaceKey } = ctx.params;
  const documentPath = ctx.query.path;
  const documentDirectory = documentPath + '.ink';
 ...
 */
const deleteDocumentAttributes = async (ctx: Router.RouterContext) => {
  const { spaceKey } = ctx.params;
  const documentPath = ctx.query.path;
  const documentDirectory = documentPath + '.ink';
